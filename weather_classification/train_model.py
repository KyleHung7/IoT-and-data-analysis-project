...
BATCH_SIZE = 32
EPOCHS = 20
DATA_DIR = "ACDC_dataset_mod2/ds"  # training dataset folder path
...
# ========
plt.figure()
plt.plot(epochs_ran, acc, marker="o", label="Train Accuracy")
plt.plot(epochs_ran, val_acc, marker="o", label="Val Accuracy")
...
# ========
plt.figure()
plt.plot(epochs_ran, loss, marker="o", label="Train Loss")
plt.plot(epochs_ran, val_loss, marker="o", label="Val Loss")
